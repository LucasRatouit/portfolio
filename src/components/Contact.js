...
function Contact() {
    ...
    function Input(props) {
        return <><label htmlFor={props.for} className='text-white font-semibold text-1xl pt-6'>{props.nameLabel}</label>
    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <form className='bg-zinc-700 flex flex-col gap-y-2 px-6 pb-6 rounded-lg w-920 max-sm:w-full' ref={form} onSubmit={sendEmail}>
                ...
                <label htmlFor="message" className='text-white font-semibold text-1xl pt-6'>Message</label>
